        ...
        content: [
  ...
  
          {
            table: {
              ...
              body: getTableBody(acreditacion),
            },
          },
          '\n\n',
          {
            table: {
              headerRows: 1,
              widths: ['auto', '*', '*', '*'],
              body: armarTotalesTablaAcreditacion(acreditacion.totalEmpleados, acreditacion.totalImporte),
            },
          },
        ],
      };
...
function getTableBody(MockedData :Acreditacion) {
    ...
    for (let j = 0; j < totalEmpleados; j++) {
      body.push([
        ...
        },
        {
          ...
          text: "pepe", // MockedData.acreditacionEmpleados[j].empleado.nombre,
          fontSize: 10,
          fillColor: '',
          alignment: 'left',
          border: upDown,
  ...
  function armarTotalesTablaAcreditacion(totalEmpleados: number, totalImporte: number) {
    // eslint-disable-next-line no-var
    var body = [
      [
        {
